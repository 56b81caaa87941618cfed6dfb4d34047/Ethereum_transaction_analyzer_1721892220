...
Vue.component("purple_feature_grid_component_1721892221", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the game with our cutting-edge technology that monitors and analyzes new Ethereum transactions in real-time, giving you a competitive edge.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Gain valuable insights into Ethereum transactions with our comprehensive analysis tools. Uncover hidden patterns, identify irregularities, and make informed decisions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Set up custom alerts and notifications to stay informed about transactions that match your predefined criteria, ensuring you never miss a critical event.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Navigate through our intuitive dashboard, where you can visualize transaction data, monitor trends, and access valuable analytics with ease.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our platform is built with security and reliability in mind, ensuring your data remains safe and your analysis processes run smoothly without interruptions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Effortlessly integrate our Ethereum transaction analysis tools into your existing workflows and systems, streamlining your operations and enhancing efficiency.</p></div>
        </div>
    </div>`,
        data() {
            return {
